...
from env_file_loader import load_local_env
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Pass --disable-supabase-read to Step1, forcing direct source fetch without Supabase fallback.",
    )
    parser.add_argument(
        "--fetch-days",
        type=int,
    ...
    if args.disable_supabase_read:
        os.environ["DPR_DISABLE_SUPABASE_RETRIEVAL"] = "1"
